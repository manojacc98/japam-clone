...
//   return (
//     <Link href={link} className="group relative w-[220px] shrink-0">
//       <div
...
//             {discount}% off
//           </div>
//           <div className="absolute top-2 left-2 mt-6 bg-yellow-300 text-black text-xs px-2 py-1 rounded shadow">
//             New arrival
//           </div>
...
//         </div>
//       </div>
//       <h4 className="mt-2 text-sm font-semibold text-gray-800 leading-tight">
//         {title}
//       </h4>
//       <div className="text-sm">
//         <span className="text-gray-900 font-semibold">₹ {price}
//         </span>
//         <span className="text-gray-500 line-through ml-2">₹ {originalPrice}
//         </span>
//       </div>
//     </Link>
//   );
